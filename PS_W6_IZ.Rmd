...
fb <- matrix(c(fb1, fb2, fb3, fb4, fb5), nrow=5, ncol=5, byrow=TRUE) # black fertility rates by education
...
fw <- matrix(c(fw1, fw2, fw3, fw4, fw5), nrow=5, ncol=5, byrow=TRUE) # white fertility rates by education

# 5Li0t = 5Li0t/(2*l0it) (p19)
Lb1 <- data$nLx[1]/(2*100000) 
Lb2 <- data$nLx[11]/(2*100000)
Lb3 <- data$nLx[21]/(2*100000)
Lb4 <- data$nLx[31]/(2*100000)
Lb5 <- data$nLx[41]/(2*100000)

Lw1 <- data$nLx[51]/(2*100000)
Lw2 <- data$nLx[61]/(2*100000)
Lw3 <- data$nLx[71]/(2*100000)
Lw4 <- data$nLx[81]/(2*100000)
Lw5 <- data$nLx[91]/(2*100000)

Lb <- matrix(c(Lb1, Lb2, Lb3, Lb4, Lb5), nrow=5, ncol=5, byrow=TRUE) 
Lw <- matrix(c(Lw1, Lw2, Lw3, Lw4, Lw5), nrow=5, ncol=5, byrow=TRUE) 


#Survival matrix = nLx+1/nLx
